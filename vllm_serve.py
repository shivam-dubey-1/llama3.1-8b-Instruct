...
@serve.deployment(name="llama-deployment", route_prefix="/vllm",
...
class VLLMDeployment:
    def __init__(self, **kwargs):
        ...
        args = AsyncEngineArgs(
            model=os.getenv("MODEL_ID", "meta-llama/Llama-3.1-8B-Instruct"),  # Model identifier from Hugging Face Hub or local path.
